...
- The sandbox cannot download from `cdn.openart.ai` (egress policy), so Vanessa downloaded the chosen still from the result card and uploaded it. Saved as `base.png` (1296x2304). **Locked.**
